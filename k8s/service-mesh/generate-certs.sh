...
generate_service_cert "pgadmin" "pgadmin"
generate_service_cert "timescaledb" "timescaledb"
generate_service_cert "envoy" "envoy"
...
echo ""
echo "# pgAdmin Secret"
echo "kubectl create secret generic pgadmin-mtls-cert \\"
echo "  --from-file=tls.crt=$CERT_DIR/pgadmin.crt \\"
echo "  --from-file=tls.key=$CERT_DIR/pgadmin.key \\"
echo "  --from-file=ca.crt=$CERT_DIR/ca.crt"
echo ""
echo "# TimescaleDB Secret"
echo "kubectl create secret generic timescaledb-mtls-cert \\"
echo "  --from-file=tls.crt=$CERT_DIR/timescaledb.crt \\"
echo "  --from-file=tls.key=$CERT_DIR/timescaledb.key \\"
echo "  --from-file=ca.crt=$CERT_DIR/ca.crt"
echo ""
echo "# Edge Envoy Secret"
echo "kubectl create secret generic envoy-mtls-cert \\"
echo "  --from-file=tls.crt=$CERT_DIR/envoy.crt \\"
echo "  --from-file=tls.key=$CERT_DIR/envoy.key \\"
echo "  --from-file=ca.crt=$CERT_DIR/ca.crt"
